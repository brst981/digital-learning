...
//            String dataId = dataList.get(position).getLessonId();
//            Log.e("ioddd", "" + dataId);
//            if (lessonid.equals(dataList.get(position).getLessonId())) {
//                for (int k = 0; k < quizDatalist.size(); k++) {
//                    Log.e("Visites", "bdj" + dataList.size());
//                    Log.e("dataList", "" + dataList);
//                    Log.e("quizDatalist", "" + quizDatalist);
//
//
//                    inflater = (LayoutInflater) getActivity().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
//
//                    view = inflater.inflate(R.layout.quiznameinlesson, container, false);
//                    quizlinear.addView(view);
...
//            Log.e("wrongpos", "" + dataList.get(position));
//            Log.e("wropos", "" + position);
//            Log.e("wrongp", "" + dataList.get(0).getLessonName());
//
//            //    }
//
