...
class ItemMainLayout extends FrameLayout {
    ...
    public void setSelector(Drawable drawable) {
        app.com.digitallearning.TeacherModule.sdlv.Compat.setBackgroundDrawable(mItemLeftBackGroundLayout, drawable);
        app.com.digitallearning.TeacherModule.sdlv.Compat.setBackgroundDrawable(mItemRightBackGroundLayout, drawable);
    }
    ...
    protected void deleteItem(final OnItemDeleteListenerProxy onItemDeleteListenerProxy) {
        ...
        Animation.AnimationListener animationListener = new Animation.AnimationListener() {
            ...
            public void onAnimationEnd(Animation animation) {
                ViewGroup.LayoutParams layoutParams = app.com.digitallearning.TeacherModule.sdlv.ItemMainLayout.this.getLayoutParams();
                layoutParams.height = height;
                app.com.digitallearning.TeacherModule.sdlv.ItemMainLayout.this.setLayoutParams(layoutParams);
                if (onItemDeleteListenerProxy != null) {
                    onItemDeleteListenerProxy.onDelete(app.com.digitallearning.TeacherModule.sdlv.ItemMainLayout.this);
                }
            }
    ...
    private void disableBackgroundDrawable() {
        if (mNormalCustomBackgroundDrawable != null) {
            app.com.digitallearning.TeacherModule.sdlv.Compat.setBackgroundDrawable(getItemCustomView(), mNormalCustomBackgroundDrawable);
        }
        if (mNormalListSelectorDrawable != null) {
            app.com.digitallearning.TeacherModule.sdlv.Compat.setBackgroundDrawable(getItemLeftBackGroundLayout(), mNormalListSelectorDrawable);
            app.com.digitallearning.TeacherModule.sdlv.Compat.setBackgroundDrawable(getItemRightBackGroundLayout(), mNormalListSelectorDrawable);
        }
    }
    ...
    private void enableBackgroundDrawable() {
        if (mTotalCustomBackgroundDrawable != null) {
            app.com.digitallearning.TeacherModule.sdlv.Compat.setBackgroundDrawable(getItemCustomView(), mTotalCustomBackgroundDrawable);
        }

        if (mTotalListSelectorDrawable != null) {
            app.com.digitallearning.TeacherModule.sdlv.Compat.setBackgroundDrawable(getItemLeftBackGroundLayout(), mTotalListSelectorDrawable);
            app.com.digitallearning.TeacherModule.sdlv.Compat.setBackgroundDrawable(getItemRightBackGroundLayout(), mTotalListSelectorDrawable);
        }
    }
