    ...
    protected void setDragPosition(int position, boolean isWannaTransparentWhileDragging) {
        ...
        if (mOnDragListener != null && view instanceof ItemMainLayout) {
            ...
            if (isWannaTransparentWhileDragging) {
                app.com.digitallearning.TeacherModule.sdlv.Compat.setBackgroundDrawable(itemMainLayout.getItemCustomView(), new ColorDrawable(Color.TRANSPARENT));
            }
            ...
            if (isWannaTransparentWhileDragging) {
                app.com.digitallearning.TeacherModule.sdlv.Compat.setBackgroundDrawable(itemMainLayout.getItemCustomView(), backgroundDrawable);
            }
        }
    }
